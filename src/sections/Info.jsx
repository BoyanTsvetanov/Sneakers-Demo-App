  ...
  return (
    <section >
        <div className='w-full h-20 justify-around flex'>
            <div className='w-1 h-full dark:bg-light not-dark:bg-dark'></div>
        ...
        <div name="Инфо" className='border-accent-magenta/60 dark:border-light not-dark:border-dark dark:bg-gradient-to-br from-transparent to-[hsl(259,77%,25%)] bg-cover bg-center bg-no-repeat bg-fixed bg-blend-darken items-center border-4 rounded-2xl mx-28  flex flex-row max-lg:flex-col max-sm:mx-8 mb-8'>
            ...
            <div className='w-full h-full rounded-xl relative p-8 max-md:p-12'>
                <div className='absolute w-1 h-[100%] max-lg:h-[50%] bg-accent-magenta/60 dark:bg-light not-dark:bg-dark left-[50%] translate-x-[-50%] top-0 max-lg:top-[50%]'></div>
                <div className='absolute w-[50%] max-lg:w-full h-1 bg-accent-magenta/60 dark:bg-light not-dark:bg-dark right-0 top-[50%] translate-y-[-50%] '></div>
                <div className='relative border-7 border-accent-magenta dark:border-light not-dark:border-dark z-40 rounded-3xl transition-all duration-500 box-border h-full aspect-square group focus-within:outline-none'>
                    <img src="./images/info.jpg" alt="info" className='absolute w-full h-full object-contain z-10 rounded-2xl transition-all duration-500'/>
                    <video src="./videos/info.mp4" autoPlay muted loop className='absolute z-10 w-full h-full object-cover opacity-0 max-sm:opacity-100 rounded-2xl group-hover:opacity-100 group-focus:opacity-100 transition-all duration-500'></video>
                    <img src="./images/sneaker-1.png" alt="info" className='absolute w-full h-full object-contain z-10  group-hover:scale-90 group-hover:translate-y-[-3%] group-hover:rotate-3 transition-all duration-500'/>
                </div>
            </div>    
        </div>
    </section>
